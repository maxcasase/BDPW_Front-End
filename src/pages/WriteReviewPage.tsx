...
// Mismos álbumes mock que en AlbumDetailPage
const mockAlbums = [
  {
    id: 1,
    titulo: 'Abbey Road',
...
const WriteReviewPage = () => {
  ...
  const album =
    mockAlbums.find((a) => a.id === numericId) ?? mockAlbums[0];
      ...
      >
        ...
        >
          ...
          <div>
            ...
            <p style={{ color: '#888', margin: 0 }}>{album.artista}</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit}>
                  ...
                  style={{
                    ...
                    border:
                      formData.rating >= rating
                        ...
                        : '1px solid #333',
                    backgroundColor:
                      formData.rating >= rating ? '#ffd70033' : '#2a2a2a',
                    color:
                      formData.rating >= rating ? '#ffd700' : '#666',
                    cursor: 'pointer',
                    fontWeight: 'bold',
                    fontSize: '1.25rem',
                    transition: 'all 0.2s',
          ...
          >
            <button
              type="button"
              onClick={() => navigate(`/album/${numericId}`)}
              style={{
